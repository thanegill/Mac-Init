...
# Set list view text size to 11
/usr/libexec/PlistBuddy -c "Set :FK_StandardViewSettings:ListViewSettings:textSize 11" ~/Library/Preferences/com.apple.finder.plist
/usr/libexec/PlistBuddy -c "Set :StandardViewSettings:ListViewSettings:textSize 11" ~/Library/Preferences/com.apple.finder.plist
